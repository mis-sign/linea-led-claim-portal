...
function trackingButton(link) {
  if (!link) return "";
  return `<div style="text-align:center; margin-top:18px;">
    <a href="${link}" style="display:inline-block; background:linear-gradient(135deg,#ffab3d,#f2790a); color:#fff; text-decoration:none; font-weight:700; font-size:13.5px; padding:12px 26px; border-radius:10px;">Track My Claim →</a>
  </div>`;
}
